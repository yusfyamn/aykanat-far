    ...
    <footer ref={footerRef} id="contact" className="text-white">
      ...
      >
        ...
        <div className="grid gap-8 border-b border-white/10 pb-8 sm:gap-9 sm:pb-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-start">
          <div>
            <h2 className="hidden text-2xl font-bold tracking-tight sm:text-3xl md:block md:text-4xl lg:text-[3rem]">
            ...
            <p className="mt-2 max-w-[34ch] text-[0.9rem] leading-relaxed text-white/62 md:hidden">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.02] px-5 py-4 lg:ml-auto lg:w-full lg:max-w-[320px]">
            ...
            <ul className="space-y-2 text-left text-[0.95rem] text-white/60">
              <li>
                <a href="tel:+905065166156" className="transition-colors hover:text-accent">
                  +90 0506 516 6156
                </a>
              </li>
              <li>
                <a href="https://wa.me/905065166156" className="transition-colors hover:text-accent">
                  WhatsApp
                </a>
              </li>
        ...
        <div className="pt-5 sm:pt-6">
          <div className="flex items-center justify-between gap-3">
            <p className="text-[11px] text-white/40 sm:text-xs">© 2026 AYKANAT FAR. Tüm hakları saklıdır.</p>
            <a
              href="https://yusufyaman.com"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[11px] text-white/40 transition-colors hover:text-accent sm:text-xs"
            >
              by Yaman
            </a>
          </div>
          <div className="pt-2 text-center">
            <a href="/gizlilik-politikasi" className="text-[11px] text-white/35 transition-colors hover:text-accent sm:text-xs">
              Gizlilik Politikası
            </a>
            <span className="px-2 text-[11px] text-white/25 sm:text-xs">•</span>
            <a href="/kullanim-kosullari" className="text-[11px] text-white/35 transition-colors hover:text-accent sm:text-xs">
              Kullanım Koşulları
            </a>
          </div>
        </div>
